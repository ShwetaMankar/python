...
# Creating the window
wn = Tk()
wn.title('GRWPT QR Code Generator')  # window title
wn.geometry('700x700')  # default size in which window will open
...
headingFrame = Frame(wn, bd=5)
headingFrame.place(relx=0.15, rely=0.01, relwidth=0.7, relheight=0.1)
headingLabel = Label(headingFrame, text="Generate QR Code",
                     font=('Times', 20, 'bold'))  # bg='azure', -> this will create block for text
headingLabel.place(relx=0, rely=0, relwidth=1, relheight=1)

# Taking the input of the text or URL to get QR code

Frame1 = Frame(wn)  # ,bg="SteelBlue3"
Frame1.place(relx=0.10, rely=0.10, relwidth=0.7, relheight=0.3)  # tkinter place method

lable1 = Label(Frame1, text="Enter the text/URL: ", font=('Courier', 15, 'normal'))  # bg="SteelBlue3", fg='azure',
...
""""label = Label(wn, text="Enter the text/URL: ",font=('Courier',15,'normal'))
label.pack()"""""

# Getting input of the location to save QR Code
Frame2 = Frame(wn)  # frames for getting location ,bg="green"
Frame2.place(relx=0.1, rely=0.30, relwidth=0.7, relheight=0.3)

lable2 = Label(Frame2, text="Enter the location to save the QR Code: ",
               font=('Courier', 15, 'normal'))  # bg="SteelBlue3", fg='azure',
...
Frame3.place(relx=0.1, rely=0.50, relwidth=0.7, relheight=0.3)
...
Frame4.place(relx=0.1, rely=0.70, relwidth=0.7, relheight=0.3)

lable4 = Label(Frame4, text="Enter the size from 1 to 40 : ",
               font=('Courier', 15, 'normal'))  # bg="SteelBlue3", fg='azure', with 1 being 21x21
...
button = Button(wn, text='Generate Code', bg='#000fff000', font=('Courier', 15, 'normal'), command=generateCode)
